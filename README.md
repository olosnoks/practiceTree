...
**To wire this:**
1. Solder one wire to the RST signal pad on the reset button
2. Solder another wire to any GND pad or pin
3. Connect both wires to your DPDT latching switch
...
4. Your reaction time is displayed on screen in `.XXXX` format
5. **Press** the button again to return to the history screen
